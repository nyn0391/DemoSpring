...
public class EmployeeDAO {
	...
	public Map<Integer,Employee>  getEmployeeDetailsMap(){
		...
		map.put(1001, new Employee("Jack", 1001, 20000, dateOfBirth.getTime(), dateOfJoining.getTime(), 'M'));
		...
		map.put(1002, new Employee("Justin", 1002, 40000, dateOfBirth2.getTime(), dateOfJoining2.getTime(), 'M'));
		...
		map.put(1003, new Employee("Eric", 1003, 40000, dateOfBirth3.getTime(), dateOfJoining3.getTime(), 'M'));
		...
		map.put(1004, new Employee("Ammy", 1004, 50000, dateOfBirth4.getTime(), dateOfJoining4.getTime(), 'F'));
		...
		map.put(1005, new Employee("Cynthya", 1005, 60000, dateOfBirth5.getTime(), dateOfJoining5.getTime(), 'F'));
